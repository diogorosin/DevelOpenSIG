...
public class ModifiedAddressEdificationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) inflater.inflate(R.layout.fragment_modified_address_edification, container, false);
        ...
        repository.getEdificationsOfModifiedAddress(getArguments().getInt(ARG_MODIFIED_ADDRESS_IDENTIFIER)).observe(ModifiedAddressEdificationFragment.this, new Observer<List<ModifiedAddressEdificationModel>>() {
