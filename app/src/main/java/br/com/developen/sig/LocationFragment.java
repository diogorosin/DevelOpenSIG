...
public class LocationFragment extends Fragment implements OnMapReadyCallback {
    ...
    public static LocationFragment newInstance(LocationListener locationListener, Integer modifiedAddressIdentifier) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mapView = v.findViewById(R.id.fragment_location_mapview);
